...
func GetConfiguration() Configuration {
	return Configuration{
		DatabaseName:        getOrDefault("DB_NAME", "mydatabase"),
		DatabaseHost:        getOrDefault("DB_HOST", "127.0.0.1:5432"),
		DatabaseUser:        getOrDefault("DB_USER", "postgres"),
		DatabasePassword:    getOrDefault("DB_PASSWORD", "12341234"),
		MigrateToVersion:    getOrDefault("MIGRATE", "latest"),
		MigrationLocation:   getOrDefault("MIGRATION_LOCATION", "C:/Users/mrden/todo-gr6-go-main/internal/infra/database/migrations"),
